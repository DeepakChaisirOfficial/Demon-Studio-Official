...
// your real ones.
const MODS = [
  {name:'Obsidian Forge', cat:'mod', desc:'Adds a smithing rework with 40 new alloy tools and armor tiers.', ver:'v3.2.1', size:'4.1 MB', color:'#3a2a26', devices:['android','ios','windows','xbox','playstation','switch'], link:github.com/DeepakChaisirOfficial/DEMON-STUDIO/blob/main/Actions%20and%20Stuff_1.5.mcpack'},
